// @ts-nocheck
/** Wendell vine canvas — wrapped for React; original logic unchanged aside from canvas + sizing + cleanup. */
export function mountWendellVines(canvas, getSize) {
const P = {
  roots: 1,
...
if (resizeHost && typeof ResizeObserver !== "undefined") {
